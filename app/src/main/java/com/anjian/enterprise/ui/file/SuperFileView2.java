package com.anjian.enterprise.ui.file;
...
public class SuperFileView2 extends FrameLayout implements TbsReaderView.ReaderCallback {
    ...
    public SuperFileView2(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.addView(mTbsReaderView, new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
    ...
    public void displayFile(File mFile) {
        ...
        if (mFile != null && !TextUtils.isEmpty(mFile.toString())) {
          //增加下面一句解决没有TbsReaderTemp文件夹存在导致加载文件失败
            String bsReaderTemp = MyApplication.getBase_Path() + "/" + "TbsReaderTemp";
            ...
            localBundle.putString("tempPath", MyApplication.getBase_Path() + "/" + "TbsReaderTemp");
